...
private:
  ...
  QMap<int, QList<QJsonObject> > toJSONnonVector(ImageStack stack, QString imageType, QList<bool> selectedChanns);
  QMap<int, QList<QJsonObject> > toJSONnonVector(TimeLapse times, QString imageType, QList<bool> selectedChanns);
  QMap<int, QList<QJsonObject> > toJSONnonVector(Channel channels, QString imageType, QList<bool> selectedChanns);



  QList<QJsonObject> toJSONvector(ImageStack stack, QString imageType, QList<bool> selectedChanns);
  QList<QJsonObject> toJSONvector(TimeLapse times, QString imageType, QList<bool> selectedChanns);
  QList<QJsonObject> toJSONvector(Channel channels, QString imageType, QList<bool> selectedChanns);
};
