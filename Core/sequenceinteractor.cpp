                    ...
                    else
                    {
                        ...
                        if (disp_overlay[it.key()].second >= 0)
                        {
                            ...
                            if (r < feat.rows)
                            {
                                ...
                                // Radius of 1.5 px :)
                                float x = feat.at<float>(r, t)-_overlay_width,
                                        y= feat.at<float>(r, l)-_overlay_width,
                                        width= feat.at<float>(r, t)+_overlay_width,
                                        height= feat.at<float>(r, l)+_overlay_width;
